...
public final class MetadataUtil
{
    ...
    public static final JsonCodec<Map<String, List<FlexTable>>> CATALOG_CODEC;
    public static final JsonCodec<FlexTable> TABLE_CODEC;
    public static final JsonCodec<FlexColumnHandle> COLUMN_CODEC;
    ...
    static {
        ...
        CATALOG_CODEC = codecFactory.mapJsonCodec(String.class, listJsonCodec(FlexTable.class));
        TABLE_CODEC = codecFactory.jsonCodec(FlexTable.class);
        COLUMN_CODEC = codecFactory.jsonCodec(FlexColumnHandle.class);
    }
