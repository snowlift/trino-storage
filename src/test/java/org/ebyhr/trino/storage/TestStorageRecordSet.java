...
public class TestStorageRecordSet
{
    ...
    {
        RecordSet recordSet = new StorageRecordSet(new StorageSplit("test", "csv", CSV.toString()), List.of(
                new StorageColumnHandle("test", "text", createUnboundedVarcharType(), 0),
                new StorageColumnHandle("test", "value", BIGINT, 1)));
        assertEquals(recordSet.getColumnTypes(), List.of(createUnboundedVarcharType(), BIGINT));

        recordSet = new StorageRecordSet(new StorageSplit("test", "csv", CSV.toString()), List.of(
                new StorageColumnHandle("test", "value", BIGINT, 1),
                new StorageColumnHandle("test", "text", createUnboundedVarcharType(), 0)));
    ...
    {
        RecordSet recordSet = new StorageRecordSet(new StorageSplit("test", "tsv", TSV.toString()), List.of(
                new StorageColumnHandle("test", "text", createUnboundedVarcharType(), 0),
    ...
    {
        RecordSet recordSet = new StorageRecordSet(new StorageSplit("test", "txt", CSV.toString()), List.of(
                new StorageColumnHandle("test", "text", createUnboundedVarcharType(), 0)));
        RecordCursor cursor = recordSet.cursor();
    ...
    {
        RecordSet recordSet = new StorageRecordSet(new StorageSplit("test", "raw", CSV.toString()), List.of(
                new StorageColumnHandle("test", "data", createUnboundedVarcharType(), 0)));
        RecordCursor cursor = recordSet.cursor();
    ...
    {
        RecordSet recordSet = new StorageRecordSet(new StorageSplit("test", "excel", EXCEL.toString()), List.of(
                new StorageColumnHandle("test", "c1", createUnboundedVarcharType(), 0),
                new StorageColumnHandle("test", "c2", createUnboundedVarcharType(), 1)));
        RecordCursor cursor = recordSet.cursor();
